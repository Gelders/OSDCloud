...
#I noticed that the product key was not installed. 
#Therefore, I am reapplying it manually instead of relying solely on OSDCloud (even though OSDCloud handle it).
